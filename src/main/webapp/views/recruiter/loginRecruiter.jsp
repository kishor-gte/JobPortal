...
<head>
    ...
    <title>Recruiter Login | SmartInterview</title>
    ...
    * {
    ...
    .login-container { background: linear-gradient(135deg, rgba(7, 82, 61, 0.95) 0%, rgba(11, 130, 96, 0.95) 100%) !important; backdrop-filter: blur(20px) !important; -webkit-backdrop-filter: blur(20px) !important; border: 1px solid rgba(255, 255, 255, 0.25) !important; border-radius: 35px !important; padding: 50px 30px 30px 30px !important; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.3) !important; position: relative; margin-top: 40px; }
    .recruiter-icon-wrapper { position: absolute !important; top: -42px !important; left: 50% !important; transform: translateX(-50%) !important; width: 84px !important; height: 84px !important; background: white !important; border-radius: 50% !important; border: none !important; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.18) !important; margin: 0 !important; }
    .recruiter-icon { background: transparent !important; color: var(--primary) !important; box-shadow: none !important; font-size: 2.2rem !important; }
    h3, .login-subtitle, label, .forgot-password-link p, .forgot-password-link a { color: white !important; }
    ...
    button[type="submit"]:hover { background: #e6f6ee !important; }
    ...
    .input-icon.email-icon::before, .input-icon.password-icon::before, .input-icon.password-icon::after { border-color: rgba(255, 255, 255, 0.95) !important; }
    .input-icon.email-icon::after { border-top-color: rgba(255, 255, 255, 0.95) !important; }
    .input-wrapper:focus-within .input-icon.email-icon::before, .input-wrapper:focus-within .input-icon.password-icon::before, .input-wrapper:focus-within .input-icon.password-icon::after { border-color: white !important; }
    .input-wrapper:focus-within .input-icon.email-icon::after { border-top-color: white !important; }
...
<body>
        ...
        <div class="login-section">
            <div class="login-container">
                <div class="login-header">
                    <div class="recruiter-icon-wrapper">
                        <div class="recruiter-icon">R</div>
                    </div>
                ...
                <form action="${pageContext.request.contextPath}/recruiter/login1" method="post" id="loginForm">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="password" class="form-control" id="recruiterLoginPwd" name="password" placeholder="Enter your password" required style="padding-right: 50px;">
                            <span onclick="toggleRecruiterLoginPwd()" id="recruiterLoginEye" style="position:absolute;right:20px;top:50%;transform:translateY(-50%);cursor:pointer;color:#19A77B;font-size:1.1rem;z-index:3;"><i class="fas fa-eye"></i></span>
                        </div>
                ...
                <div class="forgot-password-link">
                    <p><a href="${pageContext.request.contextPath}/recruiter/forgot-password"><i class="fas fa-key"></i> Forgot Password?</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
    function toggleRecruiterLoginPwd() {
        const pwd = document.getElementById('recruiterLoginPwd');
        const eye = document.getElementById('recruiterLoginEye').querySelector('i');
