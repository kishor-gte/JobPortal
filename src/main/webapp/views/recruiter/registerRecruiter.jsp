...
<head>
    ...
    <title>Recruiter Registration | SmartInterview</title>
...
<body>
    ...
    <div class="page-header">
        <div class="container">
            ...
            <p>Register a new recruiter for your company</p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <c:if test="${not empty company}">
            <div class="company-info-card">
                ...
                <h4>${company.name}</h4>
                <p>Registering recruiter for this company</p>
            </div>
        </c:if>

        <!-- Form Container -->
        <div class="form-container">
            <form action="${pageContext.request.contextPath}/recruiter/register1/${company.id}" method="POST" id="recruiterForm">
                ...
                <div class="form-row-custom">
                    ...
                    <div class="input-icon-wrapper">
                        <i class="fas fa-user"></i>
                        <input type="text" id="name" name="name" class="form-control" placeholder="Enter recruiter full name" required />
                    </div>
                </div>
                ...
                <div class="form-row-custom">
                    ...
                    <div class="input-icon-wrapper">
                        <i class="fas fa-envelope"></i>
                        <input type="email" id="email" name="email" class="form-control" placeholder="Enter recruiter email address" required />
                    </div>
                </div>
