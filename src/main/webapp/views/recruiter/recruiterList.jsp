...
<head>
    ...
    <title>Manage Recruiters | SmartInterview</title>
...
<body>
    ...
    <div class="container">
        ...
        <div class="action-bar">
            <a href="${pageContext.request.contextPath}/recruiter/register/${company.id}" class="btn-add-recruiter">
                <i class="fas fa-user-plus"></i>
                Add New Recruiter
            </a>
            <div class="recruiter-count">
                <i class="fas fa-users"></i>
                <span>${fn:length(recruiters)} Recruiter${fn:length(recruiters) != 1 ? 's' : ''}</span>
            </div>
        </div>
        ...
        <c:choose>
            <c:when test="${empty recruiters}">
                <div class="empty-state">
                    ...
                    <p>Get started by adding your first recruiter to manage job postings.</p>
                    <a href="${pageContext.request.contextPath}/recruiter/register/${company.id}" class="btn-add-recruiter">
                        <i class="fas fa-user-plus"></i>
                        Add First Recruiter
                    </a>
            ...
            <c:otherwise>
                <div class="recruiter-grid">
                    <c:forEach var="recruiter" items="${recruiters}" varStatus="status">
                        <div class="recruiter-card" style="animation-delay: ${status.index * 0.05}s;">
                            <div class="recruiter-icon">
                                <i class="fas fa-user-tie"></i>
                            </div>
                            <h3 class="recruiter-name">${recruiter.name}</h3>
                            <div class="recruiter-email">
                                <i class="fas fa-envelope"></i>
                                <span>${recruiter.email}</span>
                            </div>
                            <div class="card-actions">
                                <a href="${pageContext.request.contextPath}/recruiter/edit/${recruiter.id}" class="btn-action btn-edit">
                                    <i class="fas fa-edit"></i>
                                    Edit
                                </a>
                                <a href="${pageContext.request.contextPath}/recruiter/delete/${recruiter.id}" 
                                   class="btn-action btn-delete"
                                   onclick="return confirm('Are you sure you want to delete this recruiter? This action cannot be undone.');">
