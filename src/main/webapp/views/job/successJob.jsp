...
<title>Job Posted | JobU - Success!</title>
...
@media (max-width: 576px) {
    body { padding: 1rem; }
    .message-box { padding: 2rem 1.5rem; margin: 0 1rem; }
    h2 { font-size: 1.4rem; }
    .icon-wrapper { width: 70px; height: 70px; }
    .icon-wrapper i { font-size: 2.2rem; }
    .btn-dashboard { padding: 0.7rem 1.5rem; font-size: 0.85rem; }
}
...
<div class="message-box">
    ...
    <div class="message-content">
        ...
        Your job has been successfully posted. Candidates will now be able to view and apply.
    </div>
    <a href="${pageContext.request.contextPath}/recruiter/dashboard" class="btn-dashboard">
