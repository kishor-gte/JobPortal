...
<head>
    ...
    <title>${skill} Badge Assessment | JobU Skill Certification</title>
...
<div class="container">
    <div class="assessment-card">
        <div class="assessment-header">
            <h2><i class="fas fa-certificate" style="color: var(--accent); margin-right: 0.5rem;"></i> Skill Badge Assessment</h2>
            <div class="skill-badge">
                <i class="fas fa-code"></i> ${skill}
            </div>
        </div>

        <form action="${pageContext.request.contextPath}/assessment/submit-badge-test" method="post" id="assessmentForm">
