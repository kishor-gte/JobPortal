...
<head>
    ...
    <title>Assessment Upload Result | JobU Admin</title>
...
<div class="result-box">
    <c:choose>
        <c:when test="${not empty message}">
            <c:choose>
                <c:when test="${message.contains('Success') || message.contains('success')}">
            ...
            <h2>Assessment Upload Status</h2>
            
            <div class="message ${message.contains('Success') || message.contains('success') ? 'success' : (message.contains('Error') || message.contains('error') ? 'error' : 'info')}">
                <i class="fas ${message.contains('Success') || message.contains('success') ? 'fa-check-circle' : (message.contains('Error') || message.contains('error') ? 'fa-exclamation-circle' : 'fa-info-circle')} me-2"></i>
                ${message}
            </div>
        </c:when>
        <c:otherwise>
            ...
            <div class="message error">
                ...
                Something went wrong. No message returned.
            </div>
        </c:otherwise>
    </c:choose>

    <a href="${pageContext.request.contextPath}/admin/assessments/uploadpage" class="btn">
        Upload More Questions <i class="fas fa-arrow-right"></i>
    </a>
</div>
