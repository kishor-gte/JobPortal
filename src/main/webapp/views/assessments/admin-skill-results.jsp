...
<head>
    ...
    <title>Skill Badge Assessment Results | JobU Admin</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .premium-header h2 i { color: var(--accent); font-size: 2rem; }
        .premium-header p { opacity: 0.85; margin-top: 0.5rem; position: relative; z-index: 1; }
        ...
        .stat-badge .count { font-size: 1.5rem; font-weight: 800; color: var(--primary); }
        ...
        .user-id span { color: var(--primary); font-weight: 800; }
        ...
        .empty-state i { font-size: 4rem; background: linear-gradient(135deg, var(--primary), var(--accent)); -webkit-background-clip: text; background-clip: text; color: transparent; margin-bottom: 1rem; }
        .empty-state h3 { font-size: 1.3rem; font-weight: 700; color: var(--bg-dark); margin-bottom: 0.5rem; }
...
<div class="container">
    <div class="premium-header">
        <h2>
            ...
            Skill Badge Assessment Results
        </h2>
        <p>Track and analyze job seeker skill assessment performance</p>
    </div>
    ...
    <c:choose>
        <c:when test="${empty results}">
            <div class="empty-state">
                ...
                <p>No skill badge assessments have been completed yet.</p>
            </div>
        </c:when>
        <c:otherwise>
                    ...
                    <div class="result-card ${scoreClass}-score">
                        <div class="card-content">
                            <div class="user-header">
                                ...
                                <div class="user-info">
                                    <div class="user-id">Job Seeker ID: <span>${result.jobSeekerId}</span></div>
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (avgScoreSpan) {
        ...
        avgScoreSpan.textContent = count > 0 ? Math.round(total / count) : '0';
    }
