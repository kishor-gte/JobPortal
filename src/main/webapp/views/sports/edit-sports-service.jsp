<%@ page session="false" %>
    ...
    pageEncoding="UTF-8"%>
              ...
              <head>
                     <title>Edit Sports Service</title>
                     <meta charset="UTF-8">
                            ...
                            <div class="row justify-content-center">
                                   <div class="col-md-10">
                                          <div class="card shadow">
                                                 ...
                                                 <div class="card-body">
                                                        <form action="${pageContext.request.contextPath}/organizer/service/update"
                                                                      ...
                                                                      <div class="col-md-6">
                                                                             ...
                                                                             <select name="sportType"
                                                                                    ...
                                                                                    <option value="Cricket"
                                                                                           ${service.sportType=='Cricket'
                                                                                           ? 'selected' : '' }>Cricket
                                                                                    </option>
                                                                                    <option value="Football"
                                                                                           ${service.sportType=='Football'
                                                                                           ? 'selected' : '' }>Football
                                                                                    </option>
                                                                                    <option value="Badminton"
                                                                                           ${service.sportType=='Badminton'
                                                                                           ? 'selected' : '' }>Badminton
                                                                                    </option>
                                                                                    <option value="Tennis"
                                                                                           ${service.sportType=='Tennis'
                                                                                           ? 'selected' : '' }>Tennis
                                                                                    </option>
                                                                                    <option value="Other"
                                                                                           ${service.sportType=='Other'
                                                                                           ? 'selected' : '' }>Other
                                                                                    </option>
                                                                             </select>
                                                                      </div>
                                                               ...
                                                               <div class="row mb-3">
                                                                      ...
                                                                      <div class="col-md-3">
                                                                             <label class="form-label">Pricing
                                                                                    Unit</label>
                                                                             <select name="pricingUnit"
                                                                                    class="form-select">
                                                                                    <option value="PER_MATCH"
                                                                                           ${service.pricingUnit=='PER_MATCH'
                                                                                           ? 'selected' : '' }>Per Match
                                                                                    </option>
                                                                      ...
                                                                      <div class="col-md-3">
                                                                             ...
                                                                             <input type="number" step="0.1"
                                                                                    name="taxPercent"
                                                                                    class="form-control"
                                                                                    value="${service.taxPercent}">
                                                                      </div>
                                                                      <div class="col-md-3">
                                                                             <label class="form-label">Refundable
                                                                                    Deposit (Ã¢Â‚Â¹)</label>
                                                                             <input type="number" step="0.01"
                                                                                    name="refundableDeposit"
                                                                                    class="form-control"
                                                                                    value="${service.refundableDeposit}">
                                                                      </div>
                                                               </div>

                                                               <h5 class="text-primary mt-4 mb-3">Capacity &
                                                                      Availability</h5>
                                                               <div class="row mb-3">
                                                                      <div class="col-md-3">
                                                                             <label class="form-label">Duration
                                                                                    (Hours)</label>
                                                                             <input type="number" name="durationInHours"
                                                                                    class="form-control"
                                                                                    value="${service.durationInHours}">
                                                                      </div>
                                                                      <div class="col-md-3">
                                                               ...
                                                               <h5 class="text-primary mt-4 mb-3">Inclusions &
                                                                      Customization</h5>
                                                               <div class="row mb-3">
                                                                      <div class="col-md-3">
                                                                             <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                           type="checkbox"
                                                                                           name="refereeIncluded"
                                                                                           ${service.refereeIncluded
                                                                                           ? 'checked' : '' }>
                                                                                    <label class="form-check-label">Referee
                                                                                           Included</label>
                                                                             </div>
                                                                      </div>
                                                                      <div class="col-md-3">
                                                                             <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                           ...
                                                                                           ? 'checked' : '' }>
                                                                                    <label
                                                                                           class="form-check-label">Equipment</label>
                                                                             </div>
                                                                      </div>
                                                                      <div class="col-md-3">
                                                                             <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                           type="checkbox"
                                                                                           name="groundIncluded"
                                                                                           ${service.groundIncluded
                                                                                           ? 'checked' : '' }>
                                                                                    <label
                                                                                           class="form-check-label">Ground</label>
                                                                             </div>
                                                                      </div>
                                                                      <div class="col-md-3">
                                                                             <div class="form-check">
                                                                                    <input class="form-check-input"
                                                                                           type="checkbox"
                                                                                           name="medicalSupport"
                                                                                           ${service.medicalSupport
                                                                                           ? 'checked' : '' }>
                                                                                    <label class="form-check-label">Medical
                                                                                           Support</label>
                                                                             </div>
                                                                      </div>
                                                               </div>
                                                               <div class="mb-3">
                                                                      ...
                                                                      <input type="text" name="otherInclusions"
                                                                             class="form-control"
                                                                             value="${service.otherInclusions}">
                                                               </div>
                                                               <div class="mb-3">
                                                                      <div class="form-check">
                                                                             <input class="form-check-input"
                                                                                    type="checkbox" name="customizable"
                                                                                    ${service.customizable ? 'checked'
                                                                                    : '' }>
                                                                             <label class="form-check-label fw-bold">Customizable
                                                                                    Package?</label>
                                                                      </div>
                                                               </div>
                                                               <div class="mb-3">
                                                                      <label class="form-label">Customization
                                                                             Options</label>
                                                                      <textarea name="customizationOptions"
                                                                             class="form-control"
                                                                             rows="2">${service.customizationOptions}</textarea>
                                                               </div>

                                                               <h5 class="text-primary mt-4 mb-3">Rules & Requirements
                                                               </h5>
                                                               <div class="mb-3">
                                                                      <label class="form-label">Rules and
                                                                             Guidelines</label>
                                                                      <textarea name="rulesAndGuidelines"
                                                                             class="form-control"
                                                                             rows="3">${service.rulesAndGuidelines}</textarea>
                                                               </div>
                                                               <div class="mb-3">
                                                                      <label class="form-label">Requirements from
                                                                             Client</label>
                                                                      <textarea name="requirementsFromClient"
                                                                             class="form-control"
                                                                             rows="2">${service.requirementsFromClient}</textarea>
                                                               </div>
                                                               ...
                                                               <div class="mb-3">
                                                                      ...
                                                                      <input type="text" name="venueAddress"
                                                                             class="form-control"
                                                                             value="${service.venueAddress}">
                                                               </div>
                                                               <div class="mb-3">
                                                                      <label class="form-label">Google Maps URL</label>
                                                                      <input type="url" name="googleMapUrl"
                                                                             class="form-control"
                                                                             value="${service.googleMapUrl}">
                                                               </div>

                                                               <div class="mb-3">
                                                                      <label class="form-label">Update Cover Image
                                                                             (Leave empty to keep existing)</label>
                                                                      <input type="file" name="coverImage"
                                                                             class="form-control" accept="image/*">
                                                                      <c:if test="${not empty service.coverImageUrl}">
                                                                             <small class="text-muted">Current: <a
                                                                                           href="${pageContext.request.contextPath}${service.coverImageUrl}"
                                                                                           target="_blank">View</a></small>
                                                                      </c:if>
                                                               </div>

                                                               <div class="mb-3">
                                                                      <label class="form-label">Update Gallery Images
                                                                             (Replaces all existing if selected)</label>
