...
<a href="${pageContext.request.contextPath}/organizer/service/add">
    âž• Add New Service
</a>
...
<c:forEach var="service" items="${services}">
    <div style="border:1px solid #ddd; padding:12px; margin-bottom:10px">
        ...
        <p>${service.sportType} | â‚¹${service.basePrice}</p>

        <a href="${pageContext.request.contextPath}/organizer/service/view/${service.id}">
            View
        </a> |
        <a href="${pageContext.request.contextPath}/organizer/service/edit/${service.id}">
            Edit
        </a> |
        <a href="${pageContext.request.contextPath}/organizer/service/delete/${service.id}"
