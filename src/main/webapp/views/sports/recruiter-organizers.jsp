...
<meta charset="UTF-8">
<title>Sports Organizers</title>
</head>
<body>

<h2>Sports Organizers</h2>

<c:forEach var="org" items="${organizers}">
    <div>
        <h3>${org.organizationName}</h3>
        <p>${org.aboutOrganization}</p>
        <p>Sports: ${org.sportsHandled}</p>

        <a href="${pageContext.request.contextPath}/recruiter/services/${org.id}">
            View Services
        </a>
    </div>
</c:forEach>
