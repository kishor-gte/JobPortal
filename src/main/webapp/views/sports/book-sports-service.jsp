...
<head>
<meta charset="UTF-8">
<title>Book Sport</title>
</head>
<body>

<form action="${pageContext.request.contextPath}/recruiter/sports/book" method="post">
...
<input type="number" name="expectedParticipants" required />

<label>Final Price</label>
<input type="number" name="finalPrice" required />
