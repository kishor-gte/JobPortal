...
<body>
    ...
    <div class="main-content">
        ...
        <div class="filters">
            ...
            <a href="${pageContext.request.contextPath}/hackerrank/admin/manage-users?role=STUDENT"
                class="filter-btn ${selectedRole == 'STUDENT' ? 'active' : ''}">
                <i class="fas fa-user-graduate"></i> Students (${studentCount})
            </a>
            <a href="${pageContext.request.contextPath}/hackerrank/admin/manage-users?role=INTERVIEWER"
                class="filter-btn ${selectedRole == 'INTERVIEWER' ? 'active' : ''}">
                <i class="fas fa-chalkboard-teacher"></i> Interviewers (${interviewerCount})
            </a>
            <a href="${pageContext.request.contextPath}/hackerrank/admin/manage-users?role=ADMIN"
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="action-btns">
                                    <form action="${pageContext.request.contextPath}/hackerrank/admin/update-role/${u.id}" method="post"
                                        style="display: inline;">
                                        <select name="role" class="role-select" onchange="this.form.submit()">
                                            <option value="STUDENT" ${u.role == 'STUDENT' ? 'selected' : ''}>Student</option>
                                            <option value="INTERVIEWER" ${u.role == 'INTERVIEWER' ? 'selected' : ''}>Interviewer</option>
                                            <option value="ADMIN" ${u.role == 'ADMIN' ? 'selected' : ''}>Admin</option>
                                        </select>
                                    </form>
                                    <form action="${pageContext.request.contextPath}/hackerrank/admin/toggle-user/${u.id}" method="post"
                                        style="display: inline;">
                                        <button class="btn-sm btn-toggle" type="submit">
                                            <i class="fas fa-toggle-on"></i> Toggle
                                        </button>
                                    </form>
                                    <form action="${pageContext.request.contextPath}/hackerrank/admin/delete-user/${u.id}" method="post"
                                        style="display: inline;"
