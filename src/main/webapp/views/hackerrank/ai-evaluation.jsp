    ...
    <div class="main-content">
        ...
        <div class="evaluations-section">
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 28px; flex-wrap: wrap; gap: 16px;">
                ...
                <form action="${pageContext.request.contextPath}/hackerrank/ai-evaluation/dashboard" method="get" class="search-form">
                    ...
                    <c:if test="${not empty searchQuery}">
                        <a href="${pageContext.request.contextPath}/hackerrank/ai-evaluation/dashboard" class="clear-btn">
                ...
                <div class="eval-card" style="animation-delay: ${status.index * 0.05}s;">
                    <div class="eval-header">
                        ...
                        <div style="display: flex; align-items: center; gap: 20px;">
                            ...
                            <a href="${pageContext.request.contextPath}/hackerrank/interviewer/delete-interview/${eval.id}?redirect=/hackerrank/ai-evaluation/dashboard" 
                               class="delete-btn" 
