    ...
    <div class="container">
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div class="nav-section">
                <h4>Overview</h4>
                <a href="${pageContext.request.contextPath}/hackerrank/admin/dashboard" class="nav-link" data-tooltip="Dashboard">
                    <i class="fas fa-th-large"></i> 
                    <span>Dashboard</span>
                </a>
                <a href="${pageContext.request.contextPath}/hackerrank/admin/analytics" class="nav-link" data-tooltip="Analytics">
            ...
            <div class="nav-section">
                <h4>Management</h4>
                <a href="${pageContext.request.contextPath}/hackerrank/admin/manage-users" class="nav-link" data-tooltip="Manage Users">
            ...
            <div class="nav-section">
                <h4>Evaluation</h4>
                <a href="${pageContext.request.contextPath}/hackerrank/admin/results" class="nav-link active" data-tooltip="View Results">
                    <i class="fas fa-poll"></i> 
                    <span>View Results</span>
                </a>
                <a href="${pageContext.request.contextPath}/hackerrank/ai-evaluation/dashboard" class="nav-link" data-tooltip="AI Evaluations">
            ...
            <div class="nav-section">
                <h4>Account</h4>
                <a href="${pageContext.request.contextPath}/hackerrank/admin/account" class="nav-link" data-tooltip="Account Settings">
                    <i class="fas fa-user-circle"></i> 
                    <span>Account</span>
                </a>
                <a href="${pageContext.request.contextPath}/hackerrank/logout" class="nav-link" data-tooltip="Logout">
