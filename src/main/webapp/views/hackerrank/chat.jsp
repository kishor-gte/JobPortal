...
<head>
    ...
    <title>Chat - SmartInterview</title>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        @media (max-width: 768px) {
            ...
            .nav-sidebar.active, .chat-sidebar.active {
                transform: translateX(0);
...
<body>
    ...
    <script>
        ...
        if (messageInput) {
            messageInput.addEventListener('input', function() {
                if (!isTyping) {
                    ...
                    fetch(`${pageContext.request.contextPath}/hackerrank/chat/api/typing`, {
                        method: 'POST',
        ...
        function pollTypingStatus() {
            ...
            fetch(`${pageContext.request.contextPath}/hackerrank/chat/api/typing-status?partnerId=${partnerId}&partnerType=${partnerType}`)
                .then(res => res.json())
                .then(data => {
                    const typingIndicator = document.getElementById('typingIndicator');
                    if (typingIndicator) {
        ...
        if (partnerId) {
            ...
            setInterval(pollTypingStatus, 1000); // Poll typing status every second
        }
