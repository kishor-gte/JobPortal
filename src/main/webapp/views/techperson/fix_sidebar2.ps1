...
foreach ($file in $files) {
    ...
    # We replace from <div class="sidebar"...> to </div> followed by <div class="main-content">
    # Note: \s* matches whitespace including newlines
    $newContent = $content -replace '(?s)<div class="sidebar" id="(?:sidebar|mainSidebar)">.*?</div>\s*<div class="main-content">', "$sidebarHtml`r`n`r`n    <div class=`"main-content`">"
    ...
    # Let's check if $newContent has actually changed, just for printing out
