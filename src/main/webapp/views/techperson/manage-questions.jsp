    ...
    <div class="main-content">
        <div class="top-bar">
            ...
            <div class="top-bar-actions">
                <a href="${pageContext.request.contextPath}/tech/add-coding-question" class="btn-logout" style="background: var(--gradient-primary); color: white; border: none;">
                    <i class="fas fa-plus"></i> Add Coding Question
                </a>
                <a href="${pageContext.request.contextPath}/tech/add-interview-question" class="btn-logout" style="background: var(--gradient-primary); color: white; border: none;">
        ...
        <div class="tab-content" id="interview-tab">
            <div class="question-list" id="interviewQuestionList">
