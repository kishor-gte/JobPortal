...
<body>
    ...
    <div class="main-content">
        ...
        <div class="add-form">
            ...
            <form action="${pageContext.request.contextPath}/tech/add-category" method="post">
                <div class="form-row">
            ...
            <c:forEach var="cat" items="${categories}" varStatus="status">
                <div class="cat-card" style="animation-delay: ${status.index * 0.05}s;">
                    ...
                    <div class="cat-footer">
                        ...
                        <form action="${pageContext.request.contextPath}/tech/delete-category/${cat.id}" method="post"
