...
<head>
    ...
    <title>Competition Registrations - Job Portal</title>
    ...
    <div class="main-content">
        <div class="header-section">
            <div class="header-title">
                <h1>Registrations: ${competition.title}</h1>
                <p>Total Registered: ${registeredUsers.size()} / ${competition.maxParticipants}</p>
            </div>
            <div>
                <a href="${pageContext.request.contextPath}/tech/manage-competitions" class="btn-back">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <div style="padding: 40px; text-align: center; color: var(--text-muted);">
                        <i class="fas fa-users-slash" style="font-size: 32px; margin-bottom: 12px; color: #cbd5e1;"></i>
                        <p>No students have registered for this competition yet.</p>
                    </div>
                </c:otherwise>
            </c:choose>
        </div>
