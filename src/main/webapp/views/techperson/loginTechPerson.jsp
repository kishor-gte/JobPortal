...
<head>
    ...
    * {
    ...
    .techperson-icon-wrapper { position: absolute !important; top: -42px !important; left: 50% !important; transform: translateX(-50%) !important; width: 84px !important; height: 84px !important; background: white !important; border-radius: 50% !important; border: none !important; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.18) !important; margin: 0 !important; }
    .techperson-icon { background: transparent !important; color: var(--primary) !important; box-shadow: none !important; font-size: 2.2rem !important; }
    ...
    .input-icon.email-icon::after { border-top-color: white !important; }
