...
<body>
    ...
    <div class="container">
        ...
        <div class="form-container">
            <c:choose>
                <c:when test="${not empty techperson}">
                    <form action="${pageContext.request.contextPath}/techperson/edit-save/${techperson.id}" method="POST" id="techpersonForm">
                </c:when>
                <c:otherwise>
                ...
                <h3 class="form-section-title">
                    ...
                    ${not empty techperson ? 'Edit Tech Person' : 'Tech Person Details'}
                </h3>
                ...
                <div class="form-row-custom">
                    ...
                    <div class="input-icon-wrapper">
                        <i class="fas fa-user"></i>
                        <input type="text" id="name" name="name" class="form-control" placeholder="Enter techperson full name" value="${techperson.name}" required />
                    </div>
                </div>
                ...
                <div class="form-row-custom">
                    ...
                    <div class="input-icon-wrapper">
                        <i class="fas fa-envelope"></i>
                        <input type="email" id="email" name="email" class="form-control" placeholder="Enter techperson email address" value="${techperson.email}" required />
                    </div>
                </div>
                ...
                <div class="form-row-custom">
                    ...
                    <div class="input-icon-wrapper">
                        <i class="fas fa-lock"></i>
                        <input type="password" id="techPassword" name="password" class="form-control" placeholder="${not empty techperson ? 'Leave blank to keep same password' : 'Enter secure password'}" ${empty techperson ? 'required' : ''} style="padding-right: 48px;" />
                ...
                <button type="submit" class="btn-submit" id="submitBtn">
                    <i class="fas fa-user-plus"></i>
                    ${not empty techperson ? 'Update Tech Person' : 'Register Tech Person'}
                </button>
            </form>
        </div>
    </div>
