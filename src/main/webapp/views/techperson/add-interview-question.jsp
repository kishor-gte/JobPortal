...
<head>
    ...
    <title>Add Interview Question - SmartInterview</title>
...
<body>
    ...
    <div class="main-content">
            ...
            <div class="add-form" style="margin-top: 2rem;">
                ...
                <h3>
                    ...
                    New Interview Question Details
                </h3>
                <form id="addInterviewQuestionForm" onsubmit="submitInterviewQuestion(event)">
                    <div class="form-grid">
    ...
    <script>
        ...
        function submitInterviewQuestion(e) {
            e.preventDefault();
            const form = document.getElementById('addInterviewQuestionForm');
            const formData = new FormData(form);
            
            fetch('/tech/add-interview-question', {
                method: 'POST',
                body: formData
            })
