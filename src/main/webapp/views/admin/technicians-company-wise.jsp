...
<div class="container">
    ...
    <div id="companyList">
        <c:forEach var="company" items="${companies}">
            <c:set var="technicians" value="${companyTechniciansMap[company.id]}" />
            <c:set var="technicianSearchText" value="" />
            <c:forEach var="t" items="${technicians}">
                <c:set var="technicianSearchText" value="${technicianSearchText} ${t.name} ${t.email}" />
            </c:forEach>
            <c:set var="searchText" value="${fn:toLowerCase(company.name)} ${fn:toLowerCase(technicianSearchText)}" />
...
function openDeleteModal(type, id, name) {
    ...
    if (type === 'company') {
        form.action = '${pageContext.request.contextPath}/admin/delete-company-with-reason/' + id;
    } else if (type === 'techperson') {
        form.action = '${pageContext.request.contextPath}/admin/delete-techperson/' + id;
    }
