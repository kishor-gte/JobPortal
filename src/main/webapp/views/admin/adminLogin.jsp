...
<head>
    ...
    .login-box, .login-container { background: linear-gradient(135deg, rgba(7, 82, 61, 0.95) 0%, rgba(11, 130, 96, 0.95) 100%) !important; backdrop-filter: blur(20px) !important; -webkit-backdrop-filter: blur(20px) !important; border: 1px solid rgba(255, 255, 255, 0.25) !important; border-radius: 35px !important; padding: 50px 30px 30px 30px !important; box-shadow: 0 20px 50px rgba(0, 0, 0, 0.3) !important; position: relative; margin-top: 40px; }
    .admin-icon-wrapper { position: absolute !important; top: -42px !important; left: 50% !important; transform: translateX(-50%) !important; width: 84px !important; height: 84px !important; background: white !important; border-radius: 50% !important; border: none !important; box-shadow: 0 8px 24px rgba(0, 0, 0, 0.18) !important; margin: 0 !important; animation: none !important; }
    .admin-icon { background: transparent !important; color: var(--primary) !important; box-shadow: none !important; font-size: 2.2rem !important; }
    h2, h3, .login-subtitle, label, .forgot a, small, .register-link p, .register-link a { color: white !important; -webkit-text-fill-color: white !important; text-shadow: none !important; }
    ...
    .register-link a { color: white !important; }
    .register-link a:hover { color: #e6f6ee !important; }
    #adminLoginEye { color: rgba(255, 255, 255, 0.7) !important; }
    .alert-danger { background: rgba(255, 0, 0, 0.2) !important; color: white !important; border-left: 4px solid #ff4444 !important; }
    .alert-success { background: rgba(25, 167, 123, 0.2) !important; color: white !important; border-left: 4px solid var(--primary) !important; }
    </style>
</head>
<body>
