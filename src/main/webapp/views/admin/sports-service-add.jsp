...
<jsp:include page="/views/commons/admin_shell_start.jsp">
  <jsp:param name="pageTitle" value="Add Sports Service"/>
  <jsp:param name="pageSubtitle" value="Create corporate events packages"/>
  <jsp:param name="activeNav" value="sports-add"/>
</jsp:include>
...
<div class="container">
<a href="${pageContext.request.contextPath}/dashboard" style="display: inline-flex; align-items: center; gap: 0.5rem; color: var(--primary); text-decoration: none; font-size: 0.85rem; font-weight: 600; background: rgba(25,167,123,0.08); padding: 0.5rem 1.2rem; border-radius: 40px; margin-bottom: 1.25rem; transition: all 0.3s ease; border: 1px solid rgba(25,167,123,0.15);" onmouseover="this.style.background='var(--primary)'; this.style.color='white'" onmouseout="this.style.background='rgba(25,167,123,0.08)'; this.style.color='var(--primary)'">
