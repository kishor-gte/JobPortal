...
<head>
    ...
    .forgot-icon { background: transparent !important; color: var(--accent) !important; box-shadow: none !important; font-size: 2.2rem !important; }
    h3, .login-subtitle, label, .forgot a, small, .register-link p, .register-link a { color: white !important; -webkit-text-fill-color: white !important; text-shadow: none !important; }
    button[type="submit"] { background: white !important; color: var(--accent) !important; border-radius: 30px !important; box-shadow: 0 8px 25px rgba(0, 0, 0, 0.15) !important; height: 48px; }
    ...
    .alert-success { background: rgba(25, 167, 123, 0.2) !important; color: white !important; border-left: 4px solid var(--accent) !important; }
    </style>
</head>
<body>
        ...
        <div class="login-container">
            ...
            <div class="register-link">
                <p>
                    ...
                    <a href="${pageContext.request.contextPath}/loginAdmin">
