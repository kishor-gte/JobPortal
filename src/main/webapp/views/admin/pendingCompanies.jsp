...
<head>
    ...
    <title>Pending Company Approvals | JobU Admin</title>
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 768px) {
            ...
            .pending-count { font-size: 0.75rem; }
        }
...
<div class="page-header">
    <div class="container">
        ...
        <h1><i class="fas fa-clock me-2" style="color: var(--accent);"></i>Companies Awaiting Approval</h1>
        <p>Review and approve pending company registration requests</p>
        <div class="pending-count">
            <i class="fas fa-exclamation-circle"></i>
            <span id="pendingCount">${fn:length(companies)} Pending Approval${fn:length(companies) != 1 ? 's' : ''}</span>
        </div>
    </div>
</div>
    ...
    <c:choose>
        <c:when test="${empty companies}">
            <div class="empty-state">
                ...
                <p>All company registrations have been reviewed. There are no pending approvals at the moment.</p>
            </div>
        </c:when>
        <c:otherwise>
                    ...
                    <div class="company-header">
                        ...
                        <div class="company-info flex-grow-1">
                            ...
                            <div class="company-details-grid">
                                ...
                                <c:if test="${not empty company.linkedInUrl}">
                                    <div class="detail-item">
                            ...
                            <c:if test="${not empty company.about}">
                                <div class="company-about">
                                    <i class="fas fa-quote-left me-2" style="color: var(--primary); opacity: 0.5;"></i>
                                    ${company.about}
                                </div>
                            </c:if>
