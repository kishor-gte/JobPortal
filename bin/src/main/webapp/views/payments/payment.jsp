...
<head>
    ...
    <title>Secure Payment | JobU - Razorpay Integration</title>
    ...
    <style>
        ...
        * {
        ...
        @media (max-width: 576px) {
            ...
            .payment-icon i { font-size: 2.2rem; }
            .amount-value { font-size: 2rem; }
            .pay-button { font-size: 1rem; padding: 0.8rem 1.5rem; }
        }
...
<div class="payment-card">
    ...
    <p style="color: var(--text-muted); font-size: 0.85rem;">Complete your transaction securely with Razorpay</p>
    
    <div class="amount-info">
        <div class="amount-label">Total Amount</div>
        <div class="amount-value">
            <i class="fas fa-rupee-sign" style="font-size: 1.5rem;"></i> 10 <small>.00</small>
        </div>
    </div>
...
<script>
    document.getElementById("payButton").onclick = function (e) {
        ...
        .then(order => {
            ...
            var options = {
                "key": "rzp_test_YourKeyID", // Replace with your key
                "amount": order.amount,
                "currency": "INR",
                "name": "JobU Payment",
                ...
                "handler": function (response) {
                    ...
                    // You can send this response to backend for confirmation
                },
                "prefill": {
                    "name": "Sunetra H",
                    "email": "sunetra@example.com",
                    "contact": "9876543210"
                },
                "theme": {
                    "color": "#19A77B"
