...
<head>
    ...
    <title>Edit Recruiter | SmartInterview</title>
...
<div class="container">
    ...
    <p class="subtitle">Update the recruiter information below</p>

    <form action="${pageContext.request.contextPath}/recruiter/update/${recruiter.id}" method="post" id="editForm">
        <div class="form-group">
            <label for="name"><i class="fas fa-user"></i> Full Name</label>
            <input type="text" id="name" name="name" value="${recruiter.name}" placeholder="Enter full name" required />
        </div>

        <div class="form-group">
            <label for="email"><i class="fas fa-envelope"></i> Email Address</label>
            <input type="email" id="email" name="email" value="${recruiter.email}" placeholder="Enter email address" required />
        </div>

        <button type="submit" class="btn-submit" id="submitBtn">
            <i class="fas fa-save"></i> Update Recruiter
        </button>
    </form>
