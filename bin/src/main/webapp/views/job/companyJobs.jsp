    ...
    <c:choose>
        ...
        <c:otherwise>
            <c:forEach var="job" items="${jobs}">
                <div class="job-card" data-type="${job.employmentType == 'INTERNSHIP' ? 'internship' : 'job'}">
                    ...
                    <div class="card-body">
                        ...
                        <div class="btn-group">
                            <a href="${pageContext.request.contextPath}/company/assessments/uploadpage?jobId=${job.id}" class="btn-edit">
